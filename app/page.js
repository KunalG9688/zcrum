...
import CompanyCarousel from "@/components/comapny-carousel";
    ...
    <div className="min-h-screen">
      ...
      <section className="container mx-auto py-20 text-center">
        ...
        <Link href="/onboarding">
          <Button size="lg" className="mr-2" aria-label="Get Started">
            Get Started
            <ChevronRight size={18} />
          </Button>
        </Link>
        <Link href="#features">
          <Button size="lg" variant="outline" className="mr-4" aria-label="Learn More">
            Learn More
